...
import net.blusoft.nmreader.Brownse_by.BrowseBy;

public class BrowseManga extends AppCompatActivity implements AdapterView.OnItemClickListener{
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id)
    {
        ...
        switch (position) {
            case 0:
                intent = new Intent(BrowseManga.this, BrowseBy.class);
